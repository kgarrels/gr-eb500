...
class GnuRadioDevice(Device, NetworkTransport):
    ...
    def clock_sources(self):
        return self._get_helper(['clock_sources', 'get_clock_sources'], lambda: Device.clock_sources(self))()
    def time_sources(self):
        return self._get_helper(['time_sources', 'get_time_sources'], lambda: Device.time_sources(self))()
    def clock_source(self, source=None):
        if source is not None:
